      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          <div className="space-y-4">
            <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter italic text-green-500">Return & Refund Policy</h1>
            <div className="h-1 w-24 bg-white rounded-full"></div>
          </div>

          <div className="space-y-12">
            {/* Cancellation Policy */}
            <section className="space-y-6 bg-zinc-900/30 p-8 rounded-3xl border border-white/5">
              ...
              <div className="grid grid-cols-1 gap-4">
                {[
                  ...
                  <div key={i} className="flex gap-4 p-6 bg-zinc-900 rounded-2xl border border-white/5">
                    ...
                    <p className="text-xs font-bold uppercase tracking-widest leading-relaxed text-zinc-300">{item.text}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section className="space-y-6 bg-zinc-900/30 p-8 rounded-3xl border border-white/5">
              ...
              <div className="space-y-4 text-sm text-zinc-300 leading-relaxed">
                ...
                <p className="bg-green-500/10 p-4 rounded-xl border border-green-500/20 text-green-500 font-bold italic">
            ...
            <section className="space-y-6">
              ...
              <div className="bg-zinc-900 p-8 rounded-3xl border border-red-500/10 space-y-4">
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex gap-3 text-[10px] font-black uppercase tracking-widest text-zinc-500">
