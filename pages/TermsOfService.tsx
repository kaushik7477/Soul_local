          ...
          <div className="space-y-8 text-zinc-300">
            <section className="bg-zinc-900/30 p-8 rounded-3xl border border-white/5 space-y-6">
              <p className="text-lg leading-relaxed">
                Soul Stich operates this website. The terms <span className="text-white font-bold italic">we, us and our</span>, refers to Soul Stich. The information on the website, tools and services is for the users.
              </p>
              ...
              <p className="text-sm text-zinc-500 italic">
                We have hosted our store on <span className="text-zinc-300">Nushop.store</span>.
              </p>
            </section>
            ...
            <div className="space-y-6">
              {sections.map((section, index) => (
                <motion.div 
                  ...
                  className="bg-zinc-900/50 p-8 rounded-3xl border border-white/5 space-y-4 hover:border-green-500/20 transition-colors"
                >
            ...
            <section className="bg-zinc-900/30 p-8 rounded-3xl border border-red-500/10 space-y-4">
