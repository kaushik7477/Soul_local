        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-bold text-zinc-500 uppercase tracking-widest">
              ...
              <li><a href="https://forms.gle/iCRMUEkU5BtYnXiE8" target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-300 transition-colors">Bulk Orders & Corporate Gifts</a></li>
              <li><a href="https://forms.gle/7zUURqfBos6ampKS7" target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-300 transition-colors">Collab With Us</a></li>
            </ul>
          </div>
